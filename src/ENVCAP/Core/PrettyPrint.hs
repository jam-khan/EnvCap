...
prettyPrintExp (Nil tA)         = "List<[nil " ++ prettyPrintTyp tA ++ "]>"
...
prettyPrintList (Nil tA)           = show tA ++ "]>"
...
prettyPrintVal (VNil typ)         = "List<[nil " ++ show typ             ++ "]>"
...
prettyPrintList' (VNil tA)           = show tA ++ "]>"
